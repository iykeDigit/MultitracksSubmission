...
<head>
	...
	<link media="all" rel="stylesheet" href="./pageToSync/css/styles.css">
		...
		<div class="wrapper mod-standard mod-gray">
			<div class="details-banner">
				...
				<div class="details-banner--hero">
					<asp:Image ID="hero_img" 
						class="details-banner--hero--img"
							runat="server" 
							ImageUrl=<%#Eval("heroURL") %> 
						/>
				</div>
				...
				<div class="details-banner--info">
					<asp:Image ID="banner_img"  
							runat="server" 
							ImageUrl=<%#Eval("imageURL") %> 
						/>

					
					<h1 runat="server" id="artistTitle" class="details-banner--info--name"><a class="details-banner--info--name--link" href="#"></a></h1>
				</div>
			</div>
			...
			<nav class="discovery--nav">
				<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
					<li class="discovery--nav--list--item tab-filter--item is-active">
						<a id="biography" runat="server" class="tab-filter" href="../artists/details.aspx?id=">Overview</a>
					</li>
					<li class="discovery--nav--list--item tab-filter--item">
						<a id="first_song_link" runat="server" class="tab-filter" href="../artists/songs/details.aspx?id=">Songs</a>
					</li>
					<li class="discovery--nav--list--item tab-filter--item">
						<a id="first_album_link" runat="server" class="tab-filter" href="../artists/albums/details.aspx?id=">Albums</a>
					</li>
							...
							<main class="discovery--section">
								<section class="standard--holder">
									<div class="discovery--section--header">
										<h2>Top Songs</h2>
										<a id="theLink" runat="server" class="discovery--section--header--view-all" href="/artists/songs/details.aspx?id=">View All</a>
									</div><!-- /.discovery-select -->

									<asp:ListView ID="TopSongsList" runat="server">
										<ItemTemplate>
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												<asp:Image runat="server" ImageUrl=<%#Eval("albumURL") %> class="song-list--item--player-img--img" 
											...
											<div class="song-list--item--right">
												...
												<a runat="server" href="#" class="song-list--item--primary"><span><%# Eval("Title")%></span></a>
												<a runat="server" class="song-list--item--secondary"><span><%# Eval("album_title")%></span></a>
												<a runat="server" class="song-list--item--secondary"><%# Eval("BPM")%></a>
												<a runat="server" class="song-list--item--secondary">4/4</a>
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										<div class="discovery--section--header">
											<h2>Albums</h2>
											<a id="album_link" runat="server" class="discovery--section--header--view-all" href="/artists/albums/details.aspx?id=">View All</a>
										</div><!-- /.discovery-select -->
